...
$this->set['image_worldmap']    = 'wo-worldmap-small.jpg';         // World (small) do not delete this one, it is the default
$this->set['image_worldmap_1']  = 'wo-worldmap-small.jpg';         // World (small) do not delete this one, it is the default
$this->set['image_worldmap_2']  = 'wo-worldmap-medium.jpg';         // World (small)
$this->set['image_worldmap_3']  = 'wo-worldmap-large.jpg';   // World (large)
$this->set['image_worldmap_4']  = 'wo-us-black-map.png';     // US (black)
$this->set['image_worldmap_5']  = 'wo-us-brown-map.png';     // US (brown)
$this->set['image_worldmap_6']  = 'wo-akus-black-map.png';   // Canada and US (black)
$this->set['image_worldmap_7']  = 'wo-akus-brown-map.png';   // Canada and US (brown)
$this->set['image_worldmap_8']  = 'wo-asia-black-map.png';   // Asia (black)
$this->set['image_worldmap_9']  = 'wo-asia-brown-map.png';   // Asia (brown)
$this->set['image_worldmap_10'] = 'wo-aus-nz-black-map.png'; // Australia and NZ (black)
$this->set['image_worldmap_11'] = 'wo-aus-nz-brown-map.png'; // Australia and NZ (brown)
$this->set['image_worldmap_12'] = 'wo-ceu-black-map.png';    // Europe Central (black)
$this->set['image_worldmap_13'] = 'wo-ceu-brown-map.png';    // Europe Central (brown)
$this->set['image_worldmap_14'] = 'wo-eu-black-map.png';     // Europe (black)
$this->set['image_worldmap_15'] = 'wo-eu-brown-map.png';     // Europe (brown)
$this->set['image_worldmap_16'] = 'wo-fin-black-map.png';    // Finland (black)
$this->set['image_worldmap_17'] = 'wo-fin-brown-map.png';    // Finland (brown)
$this->set['image_worldmap_18'] = 'wo-gb-black-map.png';     // Great Britain (black)
$this->set['image_worldmap_19'] = 'wo-gb-brown-map.png';     // Great Britain (brown)
$this->set['image_worldmap_20'] = 'wo-mwus-black-map.png';   // US Midwest (black)
$this->set['image_worldmap_21'] = 'wo-mwus-brown-map.png';   // US Midwest (brown)
$this->set['image_worldmap_22'] = 'wo-ncus-black-map.png';   // US Upper Midwest (black)
$this->set['image_worldmap_23'] = 'wo-ncus-brown-map.png';   // US Upper Midwest (brown)
$this->set['image_worldmap_24'] = 'wo-neus-black-map.png';   // US Northeast (black)
$this->set['image_worldmap_25'] = 'wo-neus-brown-map.png';   // US Northeast (brown)
$this->set['image_worldmap_26'] = 'wo-nwus-black-map.png';   // US Northwest (black)
$this->set['image_worldmap_27'] = 'wo-nwus-brown-map.png';   // US Northwest (brown)
$this->set['image_worldmap_28'] = 'wo-rmus-black-map.png';   // US Rocky Mountain (black)
$this->set['image_worldmap_29'] = 'wo-rmus-brown-map.png';   // US Rocky Mountain (brown)
$this->set['image_worldmap_30'] = 'wo-scus-black-map.png';   // US South (black)
$this->set['image_worldmap_31'] = 'wo-scus-brown-map.png';   // US South (brown)
$this->set['image_worldmap_32'] = 'wo-seus-black-map.png';   // US Southeast (black)
$this->set['image_worldmap_33'] = 'wo-seus-brown-map.png';   // US Southeast (brown)
$this->set['image_worldmap_34'] = 'wo-swus-black-map.png';   // US Southwest (black)
$this->set['image_worldmap_35'] = 'wo-swus-brown-map.png';   // US Southwest (brown)
...
// you can add more, just increment the numbers
  ...
  switch($image_worldmap_type) {
        ...
        break;
        case "2": $map_im = imagecreatefromjpeg("$image_worldmap");
        break;
        case "3": $map_im = imagecreatefrompng("$image_worldmap");
        break;
  }
  switch($image_pin_type) {
        case "1": $pin_im = imagecreatefromgif("$image_pin");
        break;
        case "2": $pin_im = imagecreatefromjpeg("$image_pin");
        break;
        case "3": $pin_im = imagecreatefrompng("$image_pin");
        break;
  }
