...
echo '<table border="0" width="99%">
 <tr><td>
  ...
  if ($this->set['allow_refresh']) echo esc_html( __( 'Refresh Rate:', 'visitor-maps' ) ) . ' ' . $this->draw_pull_down_menu('refresh', $refresh_values, (isset($_GET['refresh']))? $_GET['refresh'] : '', 'onchange="this.form.submit();"') . '<br />';
  if ($this->set['allow_profile_display']) echo esc_html( __( 'Profile Display:', 'visitor-maps' ) ). ' ' . $this->draw_pull_down_menu('show', $show_type, (isset($_GET['show']))? $_GET['show'] : '', 'onchange="this.form.submit();"') . '<br />';
